...
public class RenameFieldOpportunity extends RenameOpportunity {

	public RenameFieldOpportunity(IJavaElement element, Generator generator) {
	...
	protected JavaRefactoringDescriptor buildDescriptor() {
		...
		descriptor = (RenameJavaElementDescriptor)getDescriptor(IJavaRefactorings.RENAME_FIELD);
