...
public class ExtractConstantFieldVisitor extends ASTVisitor  {
	private Cache            cache;
	private ICompilationUnit unit;

	public ExtractConstantFieldVisitor(Cache cache, ICompilationUnit unit) {
		this.cache = cache;
		this.unit  = unit;
	}
	...
	public boolean visit(BooleanLiteral literal) {
		...
		addOpportunity(createExtractConstantFieldDescriptor(literal.getStartPosition(), literal.getLength()));
		return false;
	}
